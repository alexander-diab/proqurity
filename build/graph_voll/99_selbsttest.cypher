...
// Modell: voll. Jede Zeile muss den erwarteten Wert liefern.
...
MATCH (x:Class) RETURN 'Class' AS Label, count(x) AS Ist, 33 AS Soll, count(x) = 33 AS OK;
MATCH (x:Log) RETURN 'Log' AS Label, count(x) AS Ist, 1 AS Soll, count(x) = 1 AS OK;

// --- Kanten ---
MATCH ()-[x:CORR]->() RETURN 'CORR' AS Kante, count(x) AS Ist, 153730 AS Soll, count(x) = 153730 AS OK;
MATCH ()-[x:DF]->() RETURN 'DF' AS Kante, count(x) AS Ist, 142232 AS Soll, count(x) = 142232 AS OK;
...
MATCH ()-[x:OBSERVES]->() RETURN 'OBSERVES' AS Kante, count(x) AS Ist, 39966 AS Soll, count(x) = 39966 AS OK;
MATCH ()-[x:HAS]->() RETURN 'HAS' AS Kante, count(x) AS Ist, 39966 AS Soll, count(x) = 39966 AS OK;
MATCH ()-[x:REL]->() RETURN 'REL' AS Kante, count(x) AS Ist, 11142 AS Soll, count(x) = 11142 AS OK;
